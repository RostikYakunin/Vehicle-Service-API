package com.vehicle_service_spring_v_3.routes;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.vehicle_service_spring_v_3.routes.model.Route;
import com.vehicle_service_spring_v_3.routes.model.dto.ReturnedRoute;
import com.vehicle_service_spring_v_3.routes.model.dto.RouteDto;
import com.vehicle_service_spring_v_3.routes.resource.RouteController;
...
class RouteControllerTest {
    ...
    void setUp() {
        ...
        testReturnedRoute = ReturnedRoute.builder()
                .id(1L)
                .startOfWay("testStart")
                .endOfWay("testEnd")
                .build();
